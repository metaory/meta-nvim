local LSP = {
  ...
  DiagnosticInfo = { fg = C.info_yellow },
  DiagnosticHint = { fg = C.hint_blue },
  ...
  LspDiagnosticsUnderlineHint = { style = "bold" },

  DiagnosticUnderlineError = { style = "underline" },
  DiagnosticUnderlineWarn = { style = "underline" },
  DiagnosticUnderlineInfo = { style = "underline" },
  DiagnosticUnderlineHint = { style = "bold" },
  ...
  QuickScopePrimary = { fg = C.c05, style = "underline" },
  QuickScopeSecondary = { fg = C.c06, style = "underline" },

  NvimInternalError = { bg = C.cx1, fg = C.cf1 },
  TelescopeSelection = { fg = C.sbg, bg = C.sk2, style = "bold" },
  TelescopeMatching = { fg = C.sbg, style = "bold" },
  TelescopeNormal = { fg = C.c07, bg = C.sk3 },
  TelescopePromptCounter = { fg = C.wbg },
  TelescopeBorder = { fg = C.sk6, bg = C.sk3 },
  TelescopePromptPrefix = { fg = C.wbg },
  NvimTreeWindowPicker = { fg = C.sfg, bg = C.sbg, style = 'bold' },
  NvimTreeFolderIcon = { fg = C.blue },
  NvimTreeIndentMarker = { fg = C.sk5 },
  NvimTreeEndOfBuffer = { fg = C.sk4, bg = C.sk2 },
  NvimTreeNormal = { fg = C.sk8, bg = C.sk2 },
  -- NvimTreeNormalNC = { fg = C.sk8, bg = C.sk3 },
  NvimTreeVertSplit = { fg = C.sk2, bg = C.sk2 },
  NvimTreeFolderName = { fg = C.c04 },
  NvimTreeOpenedFolderName = { fg = C.c01, style = "italic,bold" },
  NvimTreeImageFile = { fg = C.purple },
  NvimTreeSpecialFile = { fg = C.orange },
  NvimTreeGitStaged = { fg = C.sign_add },
  NvimTreeCursorLine = { fg= C.wbg, bg = C.sk4, style = 'bold'  },
  ...
  NvimTreeRootFolder = { fg = C.c07, style = "bold" },
  NvimTreeExecFile = { fg = C.green },
  LirFloatNormal = { fg = C.light_gray, bg = C.alt_bg },
  LirDir = { fg = C.blue },
  LirSymLink = { fg = C.cyan },
  LirEmptyDirText = { fg = C.blue },
  -- BufferCurrent = { fg = C.wbg, bg = C.wk0, style = "bold"  },
  -- BufferCurrentIndex = { fg = C.yellow, bg = C.green },
  -- BufferCurrentMod = { fg = C.sbg, bg = C.wk0, style = "bold" },
  -- BufferCurrentSign = { fg = C.sbg, bg = C.wk0 },
  -- BufferCurrentTarget = { fg = C.green, bg = C.bg, style = "bold" },
  ...
  StatusLine = { fg = C.sbg, bg = C.sfg },
  StatusLineNC = { fg = C.sbg, bg = C.sfg },
  ...
  IndentBlanklineSpaceChar = { fg = C.c06 },
  IndentBlanklineSpaceCharBlankline = { fg = C.info_yellow },
  DashboardHeader = { fg = C.sbg },
  DashboardCenter = { fg = C.sk9 },
  DashboardFooter = { fg = C.sk5 },
  xmlTag = { fg = C.blue },
