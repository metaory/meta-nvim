local Treesitter = {
  ...
  TSField = { fg = C.blue },
  TSParameter = { fg = C.ebg },
  TSParameterReference = { fg = C.ebg },
  TSVariable = { fg = C.sbg },
  TSVariableBuiltin = { fg = C.cx4 },
  TSSymbol = { fg = C.cyan },
  TSText = { fg = C.fg },
  TSTextReference = { fg = C.red },
  TSPunctDelimiter = { fg = C.ebg },
  TSTagDelimiter = { fg = C.sbg },
  TSTagAttribute = { fg = C.orange },
  TSPunctBracket = { fg = C.c04 },
  TSPunctSpecial = { fg = C.cx6 },
  TSString = { fg = C.green },
  ...
  TSEnvironment = { fg = C.cx4 },
  TSEnvironmentName = { fg = C.cx5 },
  -- luaTableBlock = { fg = C.cx5 },
  -- luaTable = { fg = C.cx4 },
}
